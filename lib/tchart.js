...
(function() {
  var SvgPath, TimeLine, TimingChart,
  ...
  SvgPath = (function() {
    ...
    SvgPath.prototype.svg = function() {
      var cx, cy, j, l, len, len1, len2, len3, len4, len5, len6, n, o, p, path, q, r, ref, ref1, ref2, ref3, ref4, ref5, ref6, s, s1, s2;
      ref = this.segments;
  ...
  TimeLine = (function() {
    ...
    TimeLine.prototype.yz = function() {
      return this.y + this.config.h_line / 2.0;
    };
    ...
    TimeLine.prototype.parse = function(line) {
      ...
      while (line !== '') {
        if (maches = /^\s+/.exec(line)) {
          ...
          this.grids.push([this.xh(), this.config.grid_style]);
        } else if (maches = /^\[/.exec(line)) {
  ...
  TimingChart = (function() {
    ...
    isNumeric = function(obj) {
      ...
      if (line[0] === '@') {
        ...
        if (isNumeric(this.config[matches[1]])) {
          this.config[matches[1]] = Number(matches[2]);
        } else {
    ...
    TimingChart.prototype.processGrids = function() {
